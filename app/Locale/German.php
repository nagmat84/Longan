...
final class German implements Language
{
	...
	public function get_locale(): array
	{
		$locale = [
			...
			'ALBUM_PUBLIC_EXPL' => 'Diese Optionen wirken nur, wenn das Album mit anonymen Nutzern geteilt ist.',
			'ALBUM_FULL' => 'Original',
			'ALBUM_FULL_EXPL' => 'Bilder sind mit Originalauflösung verfügbar.',
			'ALBUM_HIDDEN' => 'Versteckt',
			'ALBUM_HIDDEN_EXPL' => 'Anonyme Nutzer benötigen den direkten Link, um auf dieses Album zuzugreifen.',
			...
			'ALBUM_DOWNLOADABLE_EXPL' => 'Der Nutzer kann dieses Album herunterladen.',
